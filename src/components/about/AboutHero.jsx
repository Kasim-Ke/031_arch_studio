  ...
  return (
    <div className="relative lg:max-w-[1440px] md:max-w-[768px] max-w-[375px] h-full  mx-auto">
      <div className="relative lg:max-w-[1110px] md:max-w-[768px] max-w-[375px]  flex-row flex justify-between items-center mx-auto ">
        ...
        <div
          data-aos="fade-down"
          className="absolute lg:top-[135px] lg:left-[460px] md:top-[200px] md:left-[350px]  lg:text-[250px]  md::leading-[200px]  md:leading-[200px] md:tracking-[-3px] md:text-[120px] font-bold text-[#EEEFF4] md:block hidden z-50"
        >
          About
        </div>
      </div>
